...
if __name__ == "__main__":
    ...
    im = cv2.imread('C:/Users/hasna/OneDrive/Documents/Year_3/3rd_year_project/gelsight_heightmap_reconstruction-master/python_version/test_data/ref.jpg')
    # plt.figure() 
    # plt.imshow(im)
    # plt.show()
    ...
    if Test:
        ...
        x_index = ab_array['x']
        y_index = ab_array['y']
        im_test = cv2.imread('C:/Users/hasna/OneDrive/Documents/Year_3/3rd_year_project/gelsight_heightmap_reconstruction-master/python_version/test_data/ref.jpg')
