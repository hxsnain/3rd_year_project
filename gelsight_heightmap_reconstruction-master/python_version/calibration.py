...
if __name__=="__main__":
   ...
   # cv2.waitKey(0)
    has_marke = True 
    img_list = glob.glob("C:/Users/hasna/OneDrive/Documents/Year_3/3rd_year_project/gelsight_heightmap_reconstruction-master/python_version/test_data/sample*.jpg")
